...
<head>
	...
	<!-- icon -->
	<link rel="icon" href="images/aifpu.jpeg" >
	<title>AIFPU | ONLINE CLEARANCE SYSTEM</title>
	<style>
	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">AIFPU | OCS</a>
			</div>
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel" style="padding:20px 20px 20px 20px;">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<img src="images/image1.jpeg" alt="AIFPU" width="460" height="200">
					</div>

					<div class="item">
						<img src="images/image2.jpeg" alt="AIFPU" width="460" height="200">
					</div>
