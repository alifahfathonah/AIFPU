...
<head>
	...
	<title>AIFPU | STUDENT ONLINE CLEARANCE SYSTEM</title>
			...
			<div class="col-md-3 left_col menu_fixed">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="#" class="site_title"><i class="fa fa-heart"></i> <span>AIFPU | OCS</span></a>
					</div>
							...
							<div class="x_panel">
								...
								<div class="x_content">
									<div class="row">
										<div class="col-md-12">
											<center>
												<strong>AIFPU | STUDENT ONLINE CLEARANCE SYSTEM</strong><br />
												Unwana, Ebonyi State
												<br />
												<br />
										...
										<div class="row">
											...
											<div class="row">
												<div class="col-md-3">
													<strong>The Rector</strong><br />
													This College <br />
													Unwana, Afikpo, Ebonyi State<br /><br />
											...
											<div class="row">
												<div class="col-md-12">
													<p>
														I have the honour to inform your good Office that I have satisfactorily accounted for all money and property accountabilities and that all reports were complied with on dates shown below :
													</p>
